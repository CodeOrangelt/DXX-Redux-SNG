...
#define UPID_GAME_INFO_SIZE			(5 + 4*2 + 395 + 7 + 9 + NUM_ARCADE_SUPERPOWERS + (NETGAME_NAME_LEN+1) + (MISSION_NAME_LEN+1) + ((MAX_PLAYERS+4)*(CALLSIGN_LEN+1+1)) + 18*12) // 368 + 27 SNG toggles + 9 arcade scalars + arcade enable flags
