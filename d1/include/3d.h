...
extern int g3d_interp_outline;      //if on, polygon models are drawn with their edges traced
extern int g3d_interp_outline_color;//colour to trace them in; -1 leaves the model's own colour
